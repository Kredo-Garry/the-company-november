<?php
    ...
    class User extends Database
    {
        ...
        public function store($request)
        {
            ...
            //Apply hashing algorithm for security purposes
        ...
        public function update($request, $files){
            ...
            if ($this->conn->query($sql)) {
                ...
                if ($photo) {
                    ...
                    //Execute query and move the photo to the Db
                    if ($this->conn->query($sql)) {
                        //move the photo to the destination
        ...
        public function delete(){
            ...
            # Create a query string and use the ID above in the WHERE clause
            $sql = "DELETE FROM users WHERE id='$id'";

            # Execute the query and if successful, call the logout method
            if ($this->conn->query($sql)) {
                $this->logout();
            }else {
